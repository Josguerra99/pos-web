...
class ProductMeasurmentTable extends Component {
  state = {
    elementStructure: { codigo: "", presentacion: "" },
  ...
  handleName = e => {
    ...
    tempElement.presentacion = e.target.value;
   ...
   */
  renderTableHead = () => {
    return <TableCell>Presentacion</TableCell>;
  };
   ...
   */
  renderTableRow = row => {
    return <TableCell>{row.presentacion}</TableCell>;
  };
  ...
  deleteMessage = () => {
    return (
      <Typography>
        Esta seguro de eliminar {this.state.tempElement.presentacion}?
      </Typography>
    );
  };
...
export default ProductMeasurmentTable;
